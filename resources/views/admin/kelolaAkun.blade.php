...
@section('title', 'Data Akun Emerald')
...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Akun karyawan Emerald</h1>
    <p class="mb-4">Seluruh akun karyawan yang ada di Database Aplikasi Penggajian Emerald</p>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <a class="btn btn-warning btn-sm mx-1" style="width: 60px;"
                                    href="{{ url('admin/data-karyawan/'.$user->employee->id.'/edit') }}"
                                    role="button">Edit</a>
                                <button type="button" class="btn btn-danger btn-sm d-inline" style="width: 60px;"
                                    data-toggle="modal" data-target="#exampleModalCenter{{ $user->id }}">Hapus</button>
                            </td>
                        </tr>
                    </a>
