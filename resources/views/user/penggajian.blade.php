                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center align-middle">
                                <button type="button" class="btn btn-info btn-sm" style="width: 50px;"
                                    data-toggle="modal" data-target=".bd-example-modal-lg{{ $e->id }}"
                                    title="Info Gaji"><i class="fas fa-info-circle fa-lg"></i></button>
                        ...
                        <tr>
                            ...
                            <td class="text-center align-middle">
                                ...
                                <form action="{{ url('printPdf/'.$e->id.'/'.$postMonth.'/'.$postYear.'/employee')}}"
